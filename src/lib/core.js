...
<style>html{background:#0B1E3D}body{margin:0}#loader{position:fixed;inset:0;z-index:9999;display:grid;place-items:center;padding:1.15rem;background:radial-gradient(120% 90% at 50% 42%,#14294A 0%,#071429 64%)}html.seen #loader{display:none}#loader .boot{display:grid;justify-items:center;width:min(300px,68vw)}#loader .boot__build{width:100%;height:auto}/* failsafe: keeps the page usable if site.css never arrives */.jump{position:absolute;left:-9999px}.brandmark img{height:44px;width:auto;object-fit:contain}.mainnav{display:none}.navpanel,.megapanel{position:absolute;opacity:0;visibility:hidden}.drawer{position:fixed;inset:0;transform:translateX(100%);visibility:hidden}.dock{position:fixed;left:0;right:0;bottom:0;transform:translateY(140%)}</style>
